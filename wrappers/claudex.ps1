...
$env:ANTHROPIC_DEFAULT_OPUS_MODEL = 'locietta/claude-opus-4-8'
$env:ANTHROPIC_DEFAULT_OPUS_MODEL_NAME = 'Claude Opus 4.8 (Locietta)'
$env:ANTHROPIC_DEFAULT_OPUS_MODEL_DESCRIPTION = 'Claude Opus 4.8 via CPA'
